...
// static char *font = "Hack Nerd Font Mono:pixelsize=30:antialias=true:autohint=true";
static char *font = "JetBrainsMono:pixelsize=30:antialias=true:autohint=true";
