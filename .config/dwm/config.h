...
/* Volume control using pactl (PulseAudio) */
/* START */
...
static const Key keys[] = {
  ...
  { MODKEY|ControlMask,         XK_d,      spawn,          {.v = (const char*[]){ "thunar", NULL } } },
	{ MODKEY|ShiftMask,             XK_r,      spawn,          {.v = launchercmd} },
...
/* other bindings */
  ...
  { MODKEY,                       XK_F6,     spawn, {.v = upvol } },    /* MOD + ↑ = Volume Up */
  { MODKEY,                       XK_F5,   spawn, {.v = downvol } },  /* MOD + ↓ = Volume Down */
  { MODKEY|ShiftMask,                       XK_F12,      spawn, {.v = mute } },     /* MOD + M = Toggle Mute */
