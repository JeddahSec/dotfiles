...
vim.opt.redrawtime = 10000 -- Allow more time for loading syntax on large filesinit.lua
vim.opt.exrc = true
vim.opt.secure = true
vim.opt.titlestring = '%f // nvim'
vim.opt.inccommand = 'split'
vim.opt.autoindent = true  -- Copy indent from previous line
vim.opt.smartindent = true -- Auto-detect { } blocks to increase/decrease indent
