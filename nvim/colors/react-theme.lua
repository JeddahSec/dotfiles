...
hl("SignColumn", { fg = p.fg_dimmer, bg = p.none })
...
hl("FoldColumn", { fg = p.fg_dimmer, bg = p.none })
...
hl("EndOfBuffer", { fg = p.fg_dimmer, bg = p.none })
...
set_hl(0, 'NeoTreeNormal', { bg = p.none })
set_hl(0, 'NeoTreeNormalNC', { bg = p.none })
